...
def find_similar_texts(text):
    ...
    return lda_model.similar_documents(text=text, vectorizer=tf_vectorizer, model=best_model, doc_topic_probs    =lda_output, documents = corpus, top_n=5)
